...
public abstract class BaseRepositoryTest {
    ...
    private void fillBookCopies() {
        bookCopies = new ArrayList<>() {{
            add(BookCopy.builder().id(1L).status("AVAILABLE").registrationDate(LocalDate.of(2019, 3, 1)).price(1365).pricePerDay(150).book(Book.builder().id(1L).build()).build());
            add(BookCopy.builder().id(2L).status("AVAILABLE").registrationDate(LocalDate.of(2020, 6, 1)).price(1638).pricePerDay(210).book(Book.builder().id(2L).build()).build());
            add(BookCopy.builder().id(3L).status("AVAILABLE").registrationDate(LocalDate.of(2021, 8, 4)).price(2496).pricePerDay(225).book(Book.builder().id(2L).build()).build());
            add(BookCopy.builder().id(4L).status("AVAILABLE").registrationDate(LocalDate.of(2017, 10, 10)).price(937).pricePerDay(128).book(Book.builder().id(5L).build()).build());
            add(BookCopy.builder().id(5L).status("AVAILABLE").registrationDate(LocalDate.of(2020, 6, 2)).price(1007).pricePerDay(311).book(Book.builder().id(3L).build()).build());
        }};
    }
